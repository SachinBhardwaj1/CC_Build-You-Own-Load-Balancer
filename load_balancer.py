...
# BACKEND_PORT = 8080  # Make sure the backend is running here

# def handle_client(client_socket):
#     """Handles client requests and forwards them to the backend server."""
#     try:
...
#         # Ensure response is fully forwarded
...
#     server.listen(5)
#     print("Load Balancer listening on port 5009...\n")
